...
async function productSeeders() {
  ...
  const harmony = new Product({
    ...
    image: process.env.IMG_PATH + "harmony.png",
    otherProperties: {
      height: "732mm",
      width: "735mm",
      depth: "516mm",
  ...
  const harmonyB43 = new Product({
    ...
    image: process.env.IMG_PATH + "harmonyB43.png",
    otherProperties: {
      height: "790mm",
      width: "735mm",
      depth: "516mm",
  ...
  const harmonyC43 = new Product({
    ...
    image: process.env.IMG_PATH + "harmonyC43.png",
    otherProperties: {
      height: "814mm",
      width: "760mm",
      depth: "462mm",
  ...
  const harmonyS43 = new Product({
    ...
    image: process.env.IMG_PATH + "harmonyS43.png",
    otherProperties: {
      height: "803mm",
      width: "736mm",
      depth: "477mm",
  ...
  const harmonyH43 = new Product({
    ...
    image: process.env.IMG_PATH + "harmonyH43.png",
    otherProperties: {
      height: "768mm",
      width: "750mm",
      depth: "433mm",
  ...
  const harmonyP43 = new Product({
    ...
    image: process.env.IMG_PATH + "harmonyP43.png",
    otherProperties: {
      height: "803mm",
      width: "680mm",
      depth: "180mm",
  ...
  const box1002 = new Product({
    ...
    image: process.env.IMG_PATH + "box1002.png",
    otherProperties: {
      height: "848mm",
      width: "682mm",
      depth: "498mm",
  ...
  const box1003 = new Product({
    ...
    image: process.env.IMG_PATH + "box1003.png",
    stock: 10,
    price: 950,
    otherProperties: {
      height: "572mm",
  ...
  const box1004 = new Product({
    ...
    description:
      "Create your wood stove from a variety of combinations: version with pyres of different sizes or without pyres, with or without bases! Personalize your Scan 1003 by adjusting the modules according to your interior, your desires and your needs. This designer wood stove combines aesthetics and practicality. The pyres initially intended for the storage of your logs were also thought of as decorative elements. Frame, books, objects will be welcome.",
    image: process.env.IMG_PATH + "box1004.png",
    stock: 10,
    price: 750,
    otherProperties: {
      height: "432mm",
  ...
  const decoA1 = new Product({
    ...
    image: process.env.IMG_PATH + "decoA1.png",
    stock: 10,
    price: 1200,
    otherProperties: {
      height: "768mm",
  ...
  const decoB2 = new Product({
    ...
    image: process.env.IMG_PATH + "decoB2.png",
    stock: 10,
    price: 1800,
    otherProperties: {
      height: "768mm",
  ...
  const decoH15 = new Product({
    ...
    image: process.env.IMG_PATH + "decoH15.png",
    stock: 10,
    price: 1900,
    otherProperties: {
      height: "768mm",
  ...
  const deco1012 = new Product({
    ...
    image: process.env.IMG_PATH + "deco1012.png",
    stock: 10,
    price: 2100,
    otherProperties: {
      height: "768mm",
  ...
  const aduro1014 = new Product({
    ...
    image: process.env.IMG_PATH + "aduro1014.png",
    stock: 10,
    price: 2100,
    otherProperties: {
      height: "768mm",
  ...
  const aduroP1 = new Product({
    ...
    image: process.env.IMG_PATH + "aduroP1.png",
    stock: 10,
    price: 2500,
    otherProperties: {
      height: "1100mm",
  ...
  const aduroP13 = new Product({
    ...
    image: process.env.IMG_PATH + "aduroP13.png",
    stock: 10,
    price: 2200,
    otherProperties: {
      height: "1100mm",
  ...
  const aduroP14 = new Product({
    ...
    image: process.env.IMG_PATH + "aduroP14.png",
    stock: 10,
    price: 2300,
    otherProperties: {
      height: "1100mm",
  ...
  const aduroP2 = new Product({
    ...
    image: process.env.IMG_PATH + "aduroP2.png",
    stock: 10,
    price: 2600,
    otherProperties: {
      height: "1267mm",
  ...
  const woodshet = new Product({
    ...
    image: process.env.IMG_PATH + "woodshed.png",
    stock: 10,
    price: 350,
    otherProperties: {
      height: "768mm",
  ...
  const pellets = new Product({
    ...
    image: process.env.IMG_PATH + "pellets.png",
    stock: 10,
    price: 30,
    otherProperties: {
      weight: "15kg",
  ...
  const charcoal = new Product({
    ...
    image: process.env.IMG_PATH + "charcoal.png",
    stock: 10,
    price: 21,
    otherProperties: {
      weight: "10kg",
  ...
  const logs = new Product({
    ...
    image: process.env.IMG_PATH + "logs.png",
    stock: 10,
    price: 10,
    otherProperties: {
      weight: "2kg",
  ...
  const toolsSet = new Product({
    ...
    image: process.env.IMG_PATH + "toolsSet.png",
    stock: 10,
    price: 21,
    otherProperties: {
      height: "720mm",
